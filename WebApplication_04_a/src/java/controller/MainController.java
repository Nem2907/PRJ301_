...
public class MainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(txtA == null || txtA.trim().length()==0){
            out.println("Plwase enter 'a' value!");
            return;
        }
          if(txtB == null || txtB.trim().length()==0){
            out.println("Plwase enter 'b' value!");
            return;
        }
          int a = 0; 
          int b = 0;
          try {
             ...
             if(a < 0){
                 out.println("A must be an positive integer number !");
                 return;
             }
        } catch (Exception e) {
          ...
          try {
             ...
             if(b < 0){
                 out.println("B must be an positive integer number !");
                 return;
             }
        } catch (Exception e) {
